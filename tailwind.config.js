  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        bgPokemonMapaFondo: "url('/fondo-map-game.png')",
        bgPokemonMapaFondo2: "url('/fondo-map-game2.png')",
        bgPokemonMapaFondo3: "url('/fondo-map-game3.png')",
        bgPokemonMapaFondo4: "url('/fondo-map-game4.png')",
